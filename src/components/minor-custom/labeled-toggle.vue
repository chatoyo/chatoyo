...
const isChecked = computed({
  ...
  set: (value: boolean) => {
    // The parent updates v-model: modelValue
...
@layer components {
  ...
  */
  .checkmark::before {
    ...
    @apply inline-block text-white absolute top-[3px] left-[6px] content-["Off"] text-[12px] transition-transform duration-200 translate-x-[19px]
  }
  ...
  */
  .toggle-container input:checked ~ .checkmark {
    @apply bg-emerald-500; /* checked:bg-emerald-400 */
  }
  ...
  */
  .toggle-container:hover input:checked ~ .checkmark {
    @apply bg-emerald-600; /* checked:hover:bg-emerald-300 */
  }
  .toggle-container:hover input:checked ~ .checkmark::after {
    @apply bg-white; /* checked:hover:after:bg-emerald-600 */
  }
  ...
  */
  .toggle-container input:disabled ~ .checkmark {
    @apply bg-slate-200 cursor-not-allowed; /* disabled:bg-slate-200 */
  }
  .toggle-container input:disabled ~ .checkmark::after {
    @apply bg-slate-300; /* disabled:after:bg-slate-300 */
  }
}
</style>
